...
class cDARound
{
    ...
    {
        if ( @target != null && @target.client != null && this.state > DA_ROUNDSTATE_NONE && this.state < DA_ROUNDSTATE_POSTROUND )
        {
...
void GT_InitGametype()
{
    ...
    G_Print( "Best Gametype in the World '" + gametype.title + "' initialized\n" );
}
